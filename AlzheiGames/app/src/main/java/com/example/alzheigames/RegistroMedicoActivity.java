    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //StringRequest stringRequest=new StringRequest(Request.Method.POST, "http://192.168.0.104/alzhei_games/registrarMedico.php", new Response.Listener<String>() {
                StringRequest stringRequest=new StringRequest(Request.Method.POST, "http://192.168.100.83/alzhei_games/registrarMedico.php", new Response.Listener<String>() {
                    @Override
