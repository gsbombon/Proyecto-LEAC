...
public class Cuidador_verResultado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerPac.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                String dirLista = "http://192.168.100.83/alzhei_games/tut35/consultarReserva.php?nombreAS="+nombrePaciente;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            spinnerPac.setAdapter(new ArrayAdapter<String>(Cuidador_verResultado.this, android.R.layout.simple_spinner_dropdown_item, pacientes));
